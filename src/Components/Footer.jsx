...
function Footer() {
  return (
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-12">
      ...
      <div>
        ...
        <ul class="space-y-5">
          ...
          <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Team Support</a></li>
          <li><a href="javascript:void(0)" class="text-gray-300 hover:text-white text-[15px]">Community Support</a></li>
        </ul>
      </div>
    ...
    <p class='text-gray-300 text-right text-[15px] mt-8'>© 2024<a href='https://readymadeui.com/' target='_blank'
      class="hover:underline mx-1">MonadStarter⚡</a>All Rights Reserved.
    </p>
  </footer>
  )
}
